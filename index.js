(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    console.log('hello, my name is Abinaya, I have made this project to showcase my front-end skills, also this app is enabled with ci/cd using gitlab ci/cd pipelines');
